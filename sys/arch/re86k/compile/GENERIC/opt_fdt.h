...
#endif
/* option `FDT_SYSCON' not defined */
#ifdef _LOCORE
 .ifndef _KERNEL_OPT_FDT_SYSCON
 .global _KERNEL_OPT_FDT_SYSCON
 .equiv _KERNEL_OPT_FDT_SYSCON,0x6e074def
 .endif
#else
__asm(" .ifndef _KERNEL_OPT_FDT_SYSCON\n .global _KERNEL_OPT_FDT_SYSCON\n .equiv _KERNEL_OPT_FDT_SYSCON,0x6e074def\n .endif");
#endif
